<x-slot name="title">{{ __('Dashboard Vendor Home') }}</x-slot>
        ...
        <div>
            <div class="row">
                <div class="col-xl-2 col-6 col-md-4">
                    <a class="wsus__dashboard_item red" href="dashboard_order.html">
                        <i class="far fa-address-book"></i>
                        <p>order</p>
                    </a>
                </div>
                <div class="col-xl-2 col-6 col-md-4">
                    <a class="wsus__dashboard_item green" href="dashboard_download.html">
                        <i class="fal fa-cloud-download"></i>
                        <p>download</p>
                    </a>
                </div>
                <div class="col-xl-2 col-6 col-md-4">
                    <a class="wsus__dashboard_item sky" href="dashboard_review.html">
                        <i class="fas fa-star"></i>
                        <p>review</p>
                    </a>
                </div>
                <div class="col-xl-2 col-6 col-md-4">
                    <a class="wsus__dashboard_item blue" href="dashboard_wishlist.html">
                        <i class="far fa-heart"></i>
                        <p>wishlist</p>
                    </a>
                </div>
                <div class="col-xl-2 col-6 col-md-4">
                    <a class="wsus__dashboard_item orange" href="dashboard_profile.html">
                        <i class="fas fa-user-shield"></i>
                        <p>profile</p>
                    </a>
                </div>
                <div class="col-xl-2 col-6 col-md-4">
                    <a class="wsus__dashboard_item purple" href="dashboard_address.html">
                    ...
                    <div class="wsus__message">
                        ...
                        <div class="wsus__message_single">
                            <div class="wsus__message_img">
                                <img src="{{asset('user/assets/images/ts-1.jpg')}}" alt="img">
                            </div>
                        ...
                        <div class="wsus__message_single">
                            <div class="wsus__message_img">
                                <img src="{{asset('user/assets/images/ts-2.jpg')}}" alt="img">
                            </div>
                            <div class="wsus__message_text">
                                <h6>susan singh</h6>
                        ...
                        <div class="wsus__message_single">
                            <div class="wsus__message_img">
                                <img src="{{asset('user/assets/images/ts-3.jpg')}}" alt="img">
                            </div>
                            <div class="wsus__message_text">
                                <h6>Mary Smith</h6>
