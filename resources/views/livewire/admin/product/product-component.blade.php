                        ...
                        <x-table.cell>
                            ...
                            <div class="dropdown dropleft d-inline">
                                ...
                                <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 28px, 0px); top: 0px; left: 0px; will-change: transform;">
                                    <a wire:navigate  class="dropdown-item has-icon" href="{{ route('admin.imagegallery.index', $item->id) }}"><i class="far fa-heart"></i>{{ __('Image Gallery') }}</a>
                                    <a wire:navigate  class="dropdown-item has-icon" href="{{ route('admin.variants.index', $item->id) }}"><i class="far fa-file"></i>{{ __('Variants') }}</a>
                                </div>
                            </div>
                        </x-table.cell>
                    </x-table.row>
